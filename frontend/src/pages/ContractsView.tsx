          ...
          <tbody>
            {filtered.map((c) => (
              <tr key={c.id}>
                ...
                <td>
                  <div style={{ fontWeight: 600, color: '#1F2937' }}>{c.employee_name}</div>
                  <div style={{ fontSize: '0.75rem', color: '#64748B' }}>{c.position || 'Standard'}</div>
                </td>
                <td>
                ...
                <td>
                  <div style={{ fontSize: '0.85rem', color: '#1F2937' }}>{c.start_date}</div>
                </td>
                <td>
                  <div style={{ fontSize: '0.85rem', color: c.end_date ? '#1F2937' : '#64748B' }}>
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            <div className="modal-header">
              <h3 style={{ fontSize: '1.15rem', color: '#1F2937' }}>Issue New Employment Contract</h3>
              <button
